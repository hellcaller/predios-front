...
import { ComponentePruebaComponent } from './paginas/componente-prueba/componente-prueba.component';
...
@NgModule({
  declarations: [AppComponent, FullLayoutComponent, ContentLayoutComponent,  ComponentePruebaComponent],
  imports: [
